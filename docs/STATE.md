...
- The handoff doc and scaffold predate the Mastra addition (07-10) — extend
  the demo-agent spec + apps layout to cover it; until then this STATE is the
  only record that Mastra is in scope.
